...
- [attention-radar.md](attention-radar.md): draft direction for recommendation liveness as an attention frontier of typed tracks, returns, stale/ghost suppression, and selection handoff.
- [predictive-interception.md](predictive-interception.md): draft direction for goal-backward execution, typed acceptance contracts, evidence projections, re-aiming, and bounded goal pursuit.
