...
func TestMigratesSchemaV75ToV78ChildTasks(t *testing.T) {
	t.Parallel()
...
func TestMigratesDraftSchemaV76ToV78ChildTaskAttempts(t *testing.T) {
	t.Parallel()
...
func TestMigratesDraftSchemaV77ToV78ChildTaskFencing(t *testing.T) {
	t.Parallel()
