...
func renderFaceAgencyContextPacket(aw RuntimeAwareness, principalRole string, mode string) string {
	...
	lines = append(lines, "- continuity_affordance: when internal repair succeeded and no user choice depends on it, present the outcome and boundary rather than the repair mechanism")
